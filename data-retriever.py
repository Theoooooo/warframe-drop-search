...
category_skip_list = ["Disclaimer:", "Table of Contents:", "Mod Drops by Source:", "Blueprint/Item Drops by Source:", "Blueprint/Item Drops by Blueprint/Item:", "Resource Drops by Source:", "Resource Drops by Resource:", "Sigil Drops by Source:", "Additional Item Drops by Source:", "Relic Drops by Source:",]
    ...
    for category in categories:
        ...
        if category_name in category_standard_list:
            ...
            for row in table.find_all('tr'):
                ...
                # Vérifie si la ligne contient une nouvelle mission (balise <th colspan="2">)
                if row.find('th', colspan="3") and current_bounty == "":
                ...
                if row.find('th', colspan="2") and current_stage == "":
